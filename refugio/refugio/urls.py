...
urlpatterns = [
    ...
    url(r'^solicitud/', include('apps.adopcion.urls', namespace="adopcion")),
    ...
    url(r'^reset/password_reset_done',password_reset_done, {'template_name':'registration/password_reset_done'},
